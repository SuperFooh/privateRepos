...
una vez creadas las claves privadas en la maquina local que queremos conectar con el repo privado, tenemos que matchearla con la llave publica en configurada en nuestro usuario de github.
